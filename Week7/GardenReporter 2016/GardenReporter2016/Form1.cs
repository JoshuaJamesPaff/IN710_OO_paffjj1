...
namespace GardenReporter2016
{
    public partial class Form1 : Form
    {
        ...
        private void btnArea_Click(object sender, EventArgs e)
        {
            ...
            //creates new delegate and then uses it to print report to listbox
            GardenManager.ProcessDelegate proccessDelegate = new GardenManager.ProcessDelegate(gardenManager.ReportArea);
            gardenManager.PrintReports(listBox1, proccessDelegate);
        ...
        private void btnCharges_Click(object sender, EventArgs e)
        {
            ...
            //creates new delegate and then uses it to print report to listbox
            GardenManager.ProcessDelegate proccessDelegate = new GardenManager.ProcessDelegate(gardenManager.ReportCharges);
            gardenManager.PrintReports(listBox1, proccessDelegate);
